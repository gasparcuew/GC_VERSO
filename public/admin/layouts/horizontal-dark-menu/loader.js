    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '/admin/src/assets/img/logo2.svg',
                    lightLogo: '/admin/src/assets/img/logo2.svg'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '..//admin/src/assets/img/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
